...
<div class="d-card">
    ...
    <div class="d-stats-grid d-stats-grid-3">
        ...
        <div class="d-stat-item">
            ...
            <small class="d-stat-label"><i class="bi bi-fire" style="color:var(--gold)"></i> Day Streak</small>
        </div>

        <div class="d-stat-item">
            <div class="d-stat-number">{{ $stats['completedSurahs'] ?? 0 }}</div>
            <small class="d-stat-label"><i class="bi bi-check2-circle" style="color:var(--emerald)"></i> Surahs
                Done</small>
        </div>

        <div class="d-stat-item">
            <div class="d-stat-number">{{ $stats['storyCount'] ?? 0 }}</div>
            <small class="d-stat-label"><i class="bi bi-journal-album" style="color:var(--emerald)"></i> Stories
                Read</small>
        </div>
    ...
    <div class="d-journey-box">
        <p class="d-journey-title"><i class="bi bi-book-half" style="color:var(--gold)"></i> Quran Journey</p>

...
@push('styles')
    <style>
        ...
        .reflect-ayah-frame::before,
        .reflect-ayah-frame::after {
            content: '';
            position: absolute;
            width: 26px;
            height: 26px;
        ...
        .hero-rosette {
            ...
            user-select: none;
            pointer-events: none;
            animation: rosette-breathe 6s ease-in-out infinite;
        }

        @keyframes rosette-breathe {
...
============================================================ --}}
    <section class="hero">
        <div class="allah-hero-bg">
            <div class="hero-rosette">ٱقْرَأْ</div>
        </div>
...
============================================================ --}}
    <section class="py-3" style="background:var(--cream-dark); border-bottom:1px solid var(--border)">
        <div class="container">
            <div class="row text-center row-cols-2 row-cols-md-5 g-3">
                ...
                <div class="col stats-box">
                    <span class="stats-number" data-target="4">0</span>
                    <small class="text-muted">Imams</small>
                </div>
            </div>
        </div>
    </section>
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const names = @json(
                ($allahNames ?? collect())->map(fn($name) => [
                        'ar' => $name->name_ar,
                        'en' => $name->meaning,
                    ]));

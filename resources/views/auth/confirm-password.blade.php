...
@section('title', 'Confirm Password — Taddabur')
...
@push('styles')
    <style>
        ...
        /* Security icon circle — gold themed */
        .icon-circle {
            width: 64px;
            height: 64px;
            border-radius: 50%;
    ...
    <section class="auth-section">
        <div class="auth-wrapper">
            ...
            <div class="auth-card p-4 p-md-5">
                ...
                <div class="text-center mb-4">
                    <div class="icon-circle mx-auto mb-3">
                        <i class="bi bi-person-lock fs-4" style="color:var(--gold)"></i>
                    </div>
                    <h4 class="heading-font mb-1" style="color:var(--ink)">Confirm your identity</h4>
                ...
                <form method="POST" action="{{ route('password.confirm') }}" id="confirm-form">
                    ...
                    <button type="submit" class="btn-gold btn w-100" id="confirm-btn">
                        <i class="bi bi-shield-check me-1"></i> Confirm & Continue
                    </button>

                    <div class="tasbih-loader mt-2" id="tasbih-loader" aria-label="Verifying…"
            ...
            <div class="text-center mt-4 px-3">
                <p class="ayah-footer fst-italic mb-1">"And He is with you wherever you are."</p>
                <p class="ayah-footer-ref">— Al-Hadid 57:4</p>
            </div>

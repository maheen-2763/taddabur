...
class ScholarSeeder extends Seeder
{
    public function run(): void
    {
        DB::transaction(function () {
            ...
            // =============================================
            $abuHanifa = Scholar::firstOrCreate(
            ...
            ScholarStudent::where('scholar_id', $abuHanifa->id)->delete();
            ...
            ScholarWork::where('scholar_id', $abuHanifa->id)->delete();
            ScholarWork::insert([
                [
                    'scholar_id'   => $abuHanifa->id,
                    'title'        => 'Fiqh al-Akbar',
            ...
            ScholarTeaching::where('scholar_id', $abuHanifa->id)->delete();
            ...
            ScholarQuote::where('scholar_id', $abuHanifa->id)->delete();
            ScholarQuote::insert([
                [
                    'scholar_id'    => $abuHanifa->id,
            ...
            ScholarStudent::where('scholar_id', $malik->id)->delete();
            ScholarStudent::insert([
                [
                    'scholar_id'  => $malik->id,
            ...
            ScholarWork::where('scholar_id', $malik->id)->delete();
            ScholarWork::insert([
                [
                    'scholar_id'   => $malik->id,
                    'title'        => 'Al-Muwatta',
            ...
            ScholarTeaching::where('scholar_id', $malik->id)->delete();
            ScholarTeaching::insert([
                [
                    'scholar_id'  => $malik->id,
            ...
            ScholarQuote::where('scholar_id', $malik->id)->delete();
            ScholarQuote::insert([
                [
                    'scholar_id'    => $malik->id,
            ...
            ScholarStudent::where('scholar_id', $shafii->id)->delete();
            ScholarStudent::insert([
                [
            ...
            ScholarWork::where('scholar_id', $shafii->id)->delete();
            ScholarWork::insert([
                [
                    'scholar_id'   => $shafii->id,
                    'title'        => 'Al-Risalah',
            ...
            ScholarTeaching::where('scholar_id', $shafii->id)->delete();
            ScholarTeaching::insert([
                [
                    'scholar_id'  => $shafii->id,
            ...
            ScholarQuote::where('scholar_id', $shafii->id)->delete();
            ScholarQuote::insert([
                [
                    'scholar_id'    => $shafii->id,
            ...
            ScholarStudent::where('scholar_id', $ahmad->id)->delete();
            ScholarStudent::insert([
                [
                    'scholar_id'  => $ahmad->id,
            ...
            ScholarWork::where('scholar_id', $ahmad->id)->delete();
            ScholarWork::insert([
                [
                    'scholar_id'   => $ahmad->id,
                    'title'        => 'Al-Musnad',
            ...
            ScholarTeaching::where('scholar_id', $ahmad->id)->delete();
            ScholarTeaching::insert([
                [
                    'scholar_id'  => $ahmad->id,
            ...
            ScholarQuote::where('scholar_id', $ahmad->id)->delete();
            ScholarQuote::insert([
                [
                    'scholar_id'    => $ahmad->id,
